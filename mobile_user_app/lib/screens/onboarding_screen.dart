...
// ─────────────────────────────────────────────────────────────
// SreaApp — root widget, decides onboarding vs login
// ─────────────────────────────────────────────────────────────
...
const List<_OnboardingPage> _pages = [
  // Page 1 — Welcome (SREA logo style)
  _OnboardingPage(
...
// ─────────────────────────────────────────────────────────────
// Page 1 — Welcome page with SREA logo style
// ─────────────────────────────────────────────────────────────
      ...
      child: ScaleTransition(
        ...
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              // SREA text logo — same style as login screen
              RichText(
                text: TextSpan(
...
// ─────────────────────────────────────────────────────────────
// Pages 2–4 — Feature pages with icon
// ─────────────────────────────────────────────────────────────
