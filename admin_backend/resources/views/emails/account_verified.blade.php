...
<body>
  <div class="wrapper">
    ...
    <div class="card">
      ...
      <p class="body-text">
        Your SREA account has been successfully verified by the San Rafael DRRMO.
      ...
      <ul class="body-text" style="margin-left: 20px; margin-bottom: 16px;">
        ...
        <li>✓ One‑tap emergency call to DRRMO</li>
      </ul>
      ...
      <p class="body-text">
        ...
        please contact the San Rafael DRRMO immediately.
      </p>
    </div>
